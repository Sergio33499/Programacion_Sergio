...
public class EscrituraLecturaTexto {
    public static void main(String[] args) {
        String fileName = "datosSergio.txt";
        String fileName1 = "/home/serpuimar2/IdeaProjects/Programacion_Sergio/datosSergio.txt";
        Path filePath = Paths.get("datosSergio.txt");
        ...
        try {
            ...
            FileReader fReader=new FileReader("datosSergio.txt");
        ...
        try {
            ...
            FileWriter file = new FileWriter("datosSergio.txt");
            //De esta manera, lo estamos AÑADIENDO al final del fichero
            FileWriter fileAppend = new FileWriter("datosSergio.txt", true);
        ...
        try {
            writerObj1 = new PrintWriter(new File("datosSergio.txt"));
