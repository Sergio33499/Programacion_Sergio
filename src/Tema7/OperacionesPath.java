...
public class OperacionesPath {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path unPath = Path.of("/home/serpuimar2/Baixades/");
        Path otroPath = Paths.get("/home/serpuimar2/Baixades/");

        // Obtener el nombre de un fichero y unirlo a la ruta de otro directorio
        Path unFile = Path.of("/home/serpuimar2/Baixades/file.txt");
        Path unDir = Path.of("/home/serpuimar2/Baixades/");
        // /home/serpuimar2/Baixades/file.txt
        System.out.println(unDir.resolve(unFile.getFileName()));

        // Relativizar una ruta respecto a otra
        Path otroFile = Path.of("/home/serpuimar2/Baixades/fotos/d.txt");
        Path otroDir = Path.of("/home/serpuimar2/Baixades/");
        // obtener fotos/d.txt
        ...
        Files.createDirectories(Path.of("/home/serpuimar2/Baixades/nueva_carpeta/test"));

        // Imprimir el contenido de un directorio
        Files.list(Path.of("/home/serpuimar2/Baixades/")).forEach(System.out::println);

        // Obtener la lista de los contenidos anidados de un directorio
        List<Path> list = Files.walk(Paths.get("/home/serpuimar2/Baixades/")).collect(Collectors.toList());

        // Imprimir los ficheros regulares de un directorio ordenados por tamaño
        Files.list(Path.of("/home/serpuimar2/Baixades/"))
        ...
        Path directorio = Path.of("/home/serpuimar2/Baixades/");
        ...
        // Nota: Asegúrate de que este archivo exista en tu carpeta o cámbialo por uno real
        Path file = Path.of("/home/serpuimar2/Baixades/archivo_ejemplo.txt");
        if (Files.exists(file)) {
            LocalDate time = LocalDate.parse(Files.getLastModifiedTime(file).toString().split("T")[0], DateTimeFormatter.ISO_DATE);
        ...
        Path relative = Path.of("/home/serpuimar2/Baixades/.");
        ...
        Path original = Path.of("/home/serpuimar2/Baixades/prueba.iml");
        Path backup = Path.of("/home/serpuimar2/Baixades/prueba.iml.backup");
        Path rename = Path.of("/home/serpuimar2/Baixades/prueba.iml.backup.1");

        // Creamos el archivo original si no existe para que los métodos siguientes no fallen
        if (!Files.exists(original)) Files.createFile(original);
